...
function instagramTagsLoadMore(settings){
	var access_token = settings.accessToken;
    var param = {access_token:access_token, next_max_tag_id: instagramBrowserNextMax};
...
jQuery.fn.instagramBrowser = function ( options ) {
	...
	var settings = {
		...
		accessToken : '2513948.de273ff.ac1c55fc0cfa4705b9765b25a727f8c5', // This a mandatory setting that allows you to specify a user token. Default is 3794301.f59def8.e08bcd8b10614074882b2d1b787e2b6f
