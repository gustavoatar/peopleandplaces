...
$(document).ready(function () {
    ...
    function focusMap() {
        ...
        map.setZoom(14);      // zoom in on city
    ...
    function updateInputs() {
        $("#lat").val(lat.toFixed(10));    // update input values to current location
        $("#lng").val(lng.toFixed(10));
    }
    ...
    map = new google.maps.Map(document.getElementById("map"), mapOptions, {streetViewControl: true});     
		...
		google.maps.event.addListener(thePanorama, 'visible_changed', function() {
			if (thePanorama.getVisible() === true) {
				...
				jQuery('#searchBtn').removeClass('panoMode');
				jQuery('.next-arrow, .prev-arrow').removeClass('hide');
        ...
        infowindow.open(map, marker);
        // drag event
        google.maps.event.addListener(marker, 'dragend', function (address) {
				var thePanorama = map.getStreetView(address);
